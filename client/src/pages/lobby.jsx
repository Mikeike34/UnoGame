...
export default function Lobby({
    ...
    return(
        <div className="min-h-screen bg-slate-900 flex items-center justify-center px-4 overflow-hidden pt-env(safe-area-inset-top) pb-env(safe-area-inset-bottom)">
